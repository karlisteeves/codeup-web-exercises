...
var favoriteFoods = ["pho", "shrimp", "lamb noodle soup", "paneer"]
...
console.log("The length of theDaysOfTheWeek array is " + daysOfTheWeek.length);
...
//Benefits would be that it makes it much faster to do the same thing, instead of hard coding it
//over and over like in the previous log example.
...
//
// for (var i = 0; i < instructors.length ; i++) {
//     if (instructors[i] === "sophie" || instructors[i] === "vivian" || instructors[i] === "sophie") {
